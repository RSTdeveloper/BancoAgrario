...
class AuthController extends BaseController
{
    ...
    public function Login()
    {
        ...
        if($data4 != 0){  
            ...
            if ($data5 == 'Si' )
            {
                $resdata = array('type' => 'error', 'message' => 'Ya tiene un acuerdo registrado');            
                echo json_encode($resdata); 
                die();   
            } 
            if( $data5=='No') 
        ...
        // if ($captcha == 'true') {
            ...
            //$tronco = $this->dataModel->GetTroncoID($schema);
            ...
            $resdata = array('type' => 'success', 'message' => 'Autenticado');
            ...
            //$this->nativesession->set('Tronco', $tronco);
            echo json_encode($resdata);
        // } else {
